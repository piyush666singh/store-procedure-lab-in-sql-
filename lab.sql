...
-------------------------------------------------------------------------------------------------------------
    -- FOR GETTING ALL LAB DATA

SELECT        dbo.tbl_publisher.publisher_PublisherName, dbo.tbl_publisher.publisher_PublisherAddress, dbo.tbl_publisher.publisher_PublisherPhone, dbo.tbl_book.book_BookID, dbo.tbl_book.book_Title, 
                         dbo.tbl_library_branch.library_branch_BranchID, dbo.tbl_library_branch.library_branch_BranchName, dbo.tbl_borrower.borrower_CardNo, dbo.tbl_borrower.borrower_BorrowerName, 
                         dbo.tbl_borrower.borrower_BorrowerAddress, dbo.tbl_book_loans.book_loans_BookID, dbo.tbl_book_loans.book_loans_DateOut, dbo.tbl_book_loans.book_loans_DueDate, dbo.tbl_book_loans.book_loans_CardNo, 
                         dbo.tbl_book_authors.book_authors_AuthorID, dbo.tbl_book_authors.book_authors_AuthorName
FROM            dbo.tbl_publisher INNER JOIN
                         dbo.tbl_book ON dbo.tbl_publisher.publisher_PublisherName = dbo.tbl_book.book_PublisherName INNER JOIN
                         dbo.tbl_book_loans ON dbo.tbl_book.book_BookID = dbo.tbl_book_loans.book_loans_BookID INNER JOIN
                         dbo.tbl_library_branch ON dbo.tbl_book_loans.book_loans_BranchID = dbo.tbl_library_branch.library_branch_BranchID INNER JOIN
                         dbo.tbl_borrower ON dbo.tbl_book_loans.book_loans_CardNo = dbo.tbl_borrower.borrower_CardNo INNER JOIN
                         dbo.tbl_book_authors ON dbo.tbl_book.book_BookID = dbo.tbl_book_authors.book_authors_BookID

						 ---------------------------------------------------------------------------------------------------------------
						-- QUERY FOR BORROWER
	SELECT        dbo.tbl_publisher.publisher_PublisherName, dbo.tbl_book.book_Title, dbo.tbl_book.book_BookID, dbo.tbl_borrower.borrower_CardNo, dbo.tbl_borrower.borrower_BorrowerName, dbo.tbl_borrower.borrower_BorrowerAddress, 
                         dbo.tbl_borrower.borrower_BorrowerPhone, dbo.tbl_library_branch.library_branch_BranchID, dbo.tbl_library_branch.library_branch_BranchName
FROM            dbo.tbl_publisher INNER JOIN
                         dbo.tbl_book ON dbo.tbl_publisher.publisher_PublisherName = dbo.tbl_book.book_PublisherName CROSS JOIN
                         dbo.tbl_borrower CROSS JOIN
                         dbo.tbl_library_branch
---------------------------------------------------------------------------------------------------------------------------------------------
                          --QUERY FOR INVENTERY REPORT 
	SELECT        dbo.tbl_publisher.publisher_PublisherName, dbo.tbl_book.book_BookID, dbo.tbl_book.book_PublisherName, dbo.tbl_book.book_Title, dbo.tbl_library_branch.library_branch_BranchID, 
                         dbo.tbl_library_branch.library_branch_BranchName, dbo.tbl_library_branch.library_branch_BranchAddress
FROM            dbo.tbl_publisher INNER JOIN
                         dbo.tbl_book ON dbo.tbl_publisher.publisher_PublisherName = dbo.tbl_book.book_PublisherName CROSS JOIN
                         dbo.tbl_library_branch
-------------------------------------------------------------------------------------------------------------------------------------------
            --QUERY FOR NUMBER OF COPY
			SELECT        dbo.tbl_publisher.publisher_PublisherName, dbo.tbl_publisher.publisher_PublisherAddress, dbo.tbl_publisher.publisher_PublisherPhone, dbo.tbl_book.book_BookID, dbo.tbl_book.book_Title, 
                         dbo.tbl_book.book_PublisherName, dbo.tbl_book_copies.book_copies_CopiesID, dbo.tbl_book_copies.book_copies_BookID, dbo.tbl_book_copies.book_copies_BranchID, dbo.tbl_book_copies.book_copies_No_Of_Copies, 
                         dbo.tbl_library_branch.library_branch_BranchID, dbo.tbl_library_branch.library_branch_BranchName
FROM            dbo.tbl_publisher INNER JOIN
                         dbo.tbl_book ON dbo.tbl_publisher.publisher_PublisherName = dbo.tbl_book.book_PublisherName INNER JOIN
                         dbo.tbl_book_copies ON dbo.tbl_book.book_BookID = dbo.tbl_book_copies.book_copies_BookID INNER JOIN
                         dbo.tbl_library_branch ON dbo.tbl_book_copies.book_copies_BranchID = dbo.tbl_library_branch.library_branch_BranchID
-------------------------------------------------------------------------------------------------------------------------------------------------
